    ...
    <div class="collapse navbar-collapse " id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
           <li class="nav-item active ">
                <a class="nav-link" href="main" style="color: orange">На главную</a>
            </li>
            <li class="nav-item active ">
...
<div class="contain">
    <div class="starter-template">
        <h1>Контакты для связи</h1>
           <div class="left">
                 <div class="aboutme col-7" style="margin-top: 3rem">
                    <h5>[alex@root]$ : ls -contacts</h5>
                    <p class="messages" >
                        <i class="fab fa-vk"></i> vk.com/therealnomokon <br>
                         <i class="fas fa-at"></i> nomokon2012@gmail.com <br>
                         <i class="fas fa-phone-volume"></i> Мобильный: +7-(999)-450-26-67 
                    </p>
                 </div>
           </div>
           <div class="right">
               <img src="{{asset('img/linkme.png')}}" style="float: right">
           </div>
    </div>
</div>
